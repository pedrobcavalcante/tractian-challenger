...
class CompanyDataSourceImpl implements CompanyDataSource {
  ...
  Future<List<Map<String, dynamic>>> getCompanies() async {
    final response = await apiClient.get(_companiesEndpoint);
  ...
  Future<List<Map<String, dynamic>>> getLocations(String companyId) async {
    final response =
        await apiClient.get('$_companiesEndpoint/$companyId/locations');
    return List<Map<String, dynamic>>.from(response);
  }
  ...
  Future<List<Map<String, dynamic>>> getAssets(String companyId) async {
    final response =
        await apiClient.get('$_companiesEndpoint/$companyId/assets');
    return List<Map<String, dynamic>>.from(response);
  }
}
